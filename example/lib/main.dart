...
class _MyAppState extends State<MyApp> {
  ...
  // Controllers
  final _tokenCtrl = TextEditingController(text:""
"eyJhbGciOiJSUzI1NiIsImtpZCI6IjZDODBDMjc5MUZBMEVCODczMDI2NzlFRDhFQzFDRTE5OTNEQTAwMjMiLCJ4NXQiOiJiSURDZVItZzY0Y3dKbm50anNIT0daUGFBQ00iLCJ0eXAiOiJKV1QifQ..BxVnTteDlOXiC55vJPX3YBg0frl7a1Ph4GBYGUCsbeYO3Pk-gnUDUk8I982nTflM9yth0j8raHFsQFPgfSx0TxBWSJspCVVSq-zkI98ulIuysVfBlBF60gKkdgBv5IY4a3hcIYb3_imN9SbiOZuy8WocXnMIh-Ae-QJJBDrrkDzraj8JLT-rDLBGVKSjy11FpzVJ8skIpPo4OvppfzjHcT8eymwSnVL-JQv-UZRm-d0BmZ7Pv4boyQQtYl5Rv4VWIQ7ern0uUg49eLTAYVgtqm2tAugAWmnYH9ifhXpg_YI9cLpZITPRzpt-zlBQq7wF9w2iBEGQhVjnPttroRVIoQ"
  );
  final _teamsLinkCtrl = TextEditingController();     // NEW: teams link
  final _groupIdCtrl = TextEditingController(text: '123e4567-e89b-12d3-a456-426614174000');       // NEW: group id (UUID)
  final _meetingTitleCtrl = TextEditingController(text: "Appointment 10");
  final _nameCtrl = TextEditingController(text: 'Ali Ahmed');
